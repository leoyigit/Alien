                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-4">
                                    <div>
                                        <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">ETA PC</label>
                                        <input
                                            type="text"
                                            placeholder="e.g. Next Week"
                                            className="w-full border border-gray-300 rounded p-2 text-sm"
                                            value={formData.eta_pc || ''}
                                            onChange={e => setFormData({ ...formData, eta_pc: e.target.value })}
                                        />
                                    </div>
                                    <div>
                                        <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">ETA SL</label>
                                        <input
                                            type="text"
                                            placeholder="e.g. In Progress"
                                            className="w-full border border-gray-300 rounded p-2 text-sm"
                                            value={formData.eta_sl || ''}
                                            onChange={e => setFormData({ ...formData, eta_sl: e.target.value })}
                                        />
                                    </div>
